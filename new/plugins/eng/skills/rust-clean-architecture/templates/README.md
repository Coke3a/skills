...
These files are generic Rust Clean Architecture templates. Copy the relevant template into a Rust
backend project and replace every `Example*`, `example_*`, and placeholder field name with
...
- Domain entities use private fields, `new()`, `from_existing()`, getters, and explicit state
