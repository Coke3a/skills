...
- Designing Next.js architecture or boundaries → use `coke-eng:nextjs-app-architecture`.
...
- `coke-eng:nextjs-app-architecture` — structure, App Router, Server/Client boundaries that this workflow tests.
