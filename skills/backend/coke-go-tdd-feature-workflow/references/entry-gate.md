...
- answer them here, or
- run coke-spec-review over spec.md first if the whole document needs a pass.
...
- Offer the three routes: point at a source, answer inline, or run `coke-spec-review`.
