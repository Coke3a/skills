---
name: coke-go-performance-optimization
...
- Implementing a normal feature → use `coke-go-clean-architecture` (plus a TDD skill).
...
- `coke-go-clean-architecture` — layer structure that must be preserved.
- `coke-rust-performance-optimization` — the Rust counterpart this skill mirrors.
