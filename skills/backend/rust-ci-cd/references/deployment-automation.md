...
- Keep environment-specific configuration in environment vars, secrets, or platform
  config.
...
- Write deployment summaries with environment, artifact, SHA, migration result, smoke
  test result, and rollback instruction.
