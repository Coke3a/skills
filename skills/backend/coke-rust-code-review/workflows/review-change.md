...
- [ ] No blocking operation inside async handlers/tasks unless isolated with spawn_blocking or
      project-approved strategy.
...
- [ ] Run or request: cargo fmt --all -- --check cargo clippy --all-targets --all- features -- -D
