...
1. List user-visible form requirements: labels, required fields, validation messages, submission result, pending/disabled state, and server errors.
...
9. Use Playwright only when the full route, browser, auth, or server behavior must be validated together.
