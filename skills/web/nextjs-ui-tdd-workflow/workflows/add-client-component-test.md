...
5. Assert user-visible output, enabled/disabled state, error messages, callbacks at public boundaries, or accessible state.
...
If the component is mostly composition around an async Server Component, prefer Playwright E2E for the page behavior.
