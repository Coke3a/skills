...
2. Write UI acceptance criteria in observable terms: what the user sees, enters, clicks, waits for, and receives.
...
4. Choose the smallest useful test level:
   ...
   - Playwright E2E only for routing, auth, async Server Components, browser/server integration, or critical journeys.
