...
Verify that `coke-nextjs-app-architecture` triggers for Next.js App Router architecture work and defers
...
- **Expected skill usage**: `coke-nextjs-app-architecture` is selected; `coke-nextjs-ui-tdd-workflow` is not
