---
name: coke-nextjs-app-architecture
...
- Writing UI tests or driving TDD → use `coke-nextjs-ui-tdd-workflow`.
...
- `coke-nextjs-ui-tdd-workflow` — UI tests and TDD for the components designed here.
