...
description:
  ...
  test summaries. Pair with coke-nextjs-app-architecture for structure.
---
...
- `coke-nextjs-app-architecture` owns Next.js structure, App Router, Server/Client boundaries, data
