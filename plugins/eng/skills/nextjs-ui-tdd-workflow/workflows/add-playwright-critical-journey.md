...
2. Keep the path short: start from the first meaningful route and finish at the user-visible success
   state.
...
5. Use locators based on role, label, text, or explicit test ids when user-facing locators are not
   enough.
