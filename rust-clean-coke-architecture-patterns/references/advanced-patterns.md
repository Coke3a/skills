...
This Rust Clean Architecture skill does not define advanced Rust patterns such as type-state APIs, generic dispatch strategy, pointer taxonomy, or optimization-oriented abstractions.
