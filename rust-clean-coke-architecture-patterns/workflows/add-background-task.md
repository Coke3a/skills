...
Background job workflow is not owned by this skill. Use this note only when a periodic task must preserve the same Clean Architecture dependency direction.
